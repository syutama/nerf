...
const Loading = () => (
    <div className="loading-page">
      <svg xmlns="http://www.w3.org/2000/svg" height="10em" viewBox="0 0 512 512" className='loading-icon'>
      ...
      <div className="nerf-loading-text headtext__cormorant" style={{ fontSize: 30 }}>NERF ARENA</div>
      <div className="loading-text p__cormorant" style={{ fontSize: 20 }}>Loading...</div>
    </div>
);
